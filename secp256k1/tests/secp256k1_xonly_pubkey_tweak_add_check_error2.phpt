--TEST--
secp256k1_xonly_pubkey_tweak_add_check errors if context is wrong resource type
--SKIPIF--
<?php
...
$tweakedParity = null;
$result = secp256k1_xonly_pubkey_tweak_add_check(tmpfile(), $tweakedPubKey32, $tweakedPubParity, $internalPub, $tweak32);
echo $result.PHP_EOL;
...
secp256k1_xonly_pubkey_tweak_add_check(): supplied resource is not a valid secp256k1_context resource
0