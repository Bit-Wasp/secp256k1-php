--TEST--
secp256k1_keypair_sec returns 0 if context is wrong resource type
--SKIPIF--
<?php
...
$sec = null;
$result = secp256k1_keypair_sec(tmpfile(), $sec, $keypair);
echo $result . PHP_EOL;

?>
--EXPECT--
1
secp256k1_keypair_sec(): supplied resource is not a valid secp256k1_context resource
0