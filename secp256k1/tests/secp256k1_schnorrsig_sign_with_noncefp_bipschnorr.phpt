--TEST--
secp256k1_schnorrsig_sign with secp256k1_nonce_function_bipschnorr matches default
--SKIPIF--
<?php
...
$sig = null;
$result = secp256k1_schnorrsig_sign($ctx, $sig, $msg32, $priv, 'secp256k1_nonce_function_bipschnorr');
echo $result . PHP_EOL;
echo get_resource_type($sig) . PHP_EOL;
