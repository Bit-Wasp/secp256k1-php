--TEST--
secp256k1_ecdsa_sign can be validated after custom nonce function and extra data
--SKIPIF--
<?php
...
$hashFxn = function (&$nonce, string $msg,
    ...
    echo "callback msg " . bin2hex($msg) . PHP_EOL;
    echo "callback key " . bin2hex($key32) . PHP_EOL;
    var_dump($algo16);
    var_dump($data);
...
$sig = null;
$result = secp256k1_ecdsa_sign($ctx, $sig, $msg32, $priv, $hashFxn, "ABCD");
echo $result . PHP_EOL;
...
--EXPECT--
triggered callback
callback msg 9e5755ec2f328cc8635a55415d0e9a09c2b6f2c9b0343c945fbbfe08247a4cbe
callback key 31a84594060e103f5a63eb742bd46cf5f5900d8406e2726dedfc61c7cf43ebad
NULL
string(4) "ABCD"
1
