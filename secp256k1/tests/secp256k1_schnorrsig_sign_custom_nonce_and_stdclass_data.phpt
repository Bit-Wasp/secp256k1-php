--TEST--
secp256k1_schnorrsig_sign works a user provided nonce function, with additional \stdClass data
--SKIPIF--
<?php
...
$hashFxn = function (&$nonce, string $msg,
    string $key32, string $xonlyPk32, string $algo16, \stdClass $data) {
...
$result = secp256k1_schnorrsig_sign($ctx, $sig, $msg32, $keypair, $hashFxn, new \stdClass());
echo $result.PHP_EOL;
