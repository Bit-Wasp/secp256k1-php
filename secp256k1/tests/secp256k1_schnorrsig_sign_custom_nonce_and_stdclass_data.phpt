--TEST--
secp256k1_schnorrsig_sign works a user provided nonce function, with additional data (stdClass)
--SKIPIF--
<?php
...
$hashFxn = function (&$nonce, string $msg,
    string $key32, ?string $algo16, \stdClass $data, int $attempt) {
...
$result = secp256k1_schnorrsig_sign($ctx, $sig, $msg32, $privKey, $hashFxn, $obj);
echo $result.PHP_EOL;
