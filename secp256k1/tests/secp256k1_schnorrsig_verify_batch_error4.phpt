--TEST--
secp256k1_schnorrsig_verify_batch errors when scratch space is wrong resource type
--SKIPIF--
<?php
...
1
tests:
secp256k1_schnorrsig_verify_batch(): supplied resource is not a valid secp256k1_scratch_space resource
0