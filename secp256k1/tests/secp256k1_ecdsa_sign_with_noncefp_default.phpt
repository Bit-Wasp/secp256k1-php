--TEST--
secp256k1_ecdsa_sign with secp256k1_nonce_function_default matches default
--SKIPIF--
<?php
...
$sig = null;
$result = secp256k1_ecdsa_sign($ctx, $sig, $msg32, $priv, 'secp256k1_nonce_function_default');
echo $result . PHP_EOL;
echo get_resource_type($sig) . PHP_EOL;
