--TEST--
secp256k1_schnorrsig_verify_batch works, and returns an error if batch fails
--SKIPIF--
<?php
...
$sigBin2 = pack("H*", "76b598bae61948c3054c19a7864b56d7b772452274c522f9608fe3cd17c13dc61226c722111ed04629965d91d10e30b4024a11c76172924373969261be41640c");
...
$result = secp256k1_schnorrsig_verify_batch(
    $ctx, $scratch, [$sig1, $sig2], [$badMsg, $msg322], [$pubKey1, $pubKey2], 2);
echo $result.PHP_EOL;

$result = secp256k1_schnorrsig_verify_batch(
    $ctx, $scratch, [$sig1, $sig2], [$msg321, $badMsg], [$pubKey1, $pubKey2], 2);
echo $result.PHP_EOL;
?>
--EXPECT--
setup:
