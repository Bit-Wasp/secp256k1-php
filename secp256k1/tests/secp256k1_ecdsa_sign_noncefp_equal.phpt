--TEST--
secp256k1_ecdsa_sign without additional data produces same signatures for secp256k1_nonce_function_default and secp256k1_nonce_function_rfc6979
--SKIPIF--
<?php
...
$sig = null;
$result = secp256k1_ecdsa_sign($ctx, $sig, $msg32, $priv, 'secp256k1_nonce_function_rfc6979', NULL);
echo $result . PHP_EOL;
...
// secp256k1_nonce_function_default, no data
$sig = null;
$result = secp256k1_ecdsa_sign($ctx, $sig, $msg32, $priv, 'secp256k1_nonce_function_default', NULL);
echo $result . PHP_EOL;
echo get_resource_type($sig) . PHP_EOL;
