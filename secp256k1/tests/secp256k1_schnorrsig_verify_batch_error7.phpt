--TEST--
secp256k1_schnorrsig_verify_batch errors when the key array has the wrong type
--SKIPIF--
<?php
...
1
tests:
secp256k1_schnorrsig_verify_batch(): supplied resource is not a valid secp256k1_xonly_pubkey resource
0