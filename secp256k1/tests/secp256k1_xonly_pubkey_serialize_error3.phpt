...
$result = secp256k1_xonly_pubkey_serialize($ctx, $pubkeyout1, tmpfile());
echo $result . PHP_EOL;
...
--EXPECT--
1
secp256k1_xonly_pubkey_serialize(): supplied resource is not a valid secp256k1_xonly_pubkey resource
0