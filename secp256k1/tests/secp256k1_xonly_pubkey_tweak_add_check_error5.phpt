--TEST--
secp256k1_xonly_pubkey_tweak_add_check throws if tweak32 is not 32 bytes
--SKIPIF--
<?php
...
try {
    $result = secp256k1_xonly_pubkey_tweak_add_check($ctx, $tweakedPubKey32, $tweakedPubParity, $internalPub, substr($tweak32, 0, 29));
    echo $result.PHP_EOL;
} catch (\Exception $e) {
