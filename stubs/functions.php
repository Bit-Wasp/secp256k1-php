 ...
 * @return int
 */
function ecdsa_signature_parse_der_lax($context, ?resource &$ecdsaSignatureOut, string $sigLaxDerIn): int {}
/**
 ...
 * @return int
 */
function secp256k1_ec_pubkey_parse($context, ?resource &$ecPublicKey, string $publicKeyIn): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_signature_parse_compact($context, ?resource &$ecdsaSignatureOut, string $sig64In): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_signature_parse_der($context, ?resource &$ecdsaSignatureOut, string $sigDerIn): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_signature_normalize($context, ?resource &$ecdsaSignatureNormalized, $ecdsaSignature): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_sign($context, ?resource &$ecdsaSignatureOut, string $msg32, string $secretKey): int {}
/**
 ...
 * @return int
 */
function secp256k1_ec_pubkey_create($context, ?resource &$ecPublicKey, string $secretKey): int {}
/**
 ...
 * @return int
 */
function secp256k1_ec_pubkey_combine($context, ?resource &$combinedEcPublicKey, array $publicKeys): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_recoverable_signature_parse_compact($context, ?resource &$ecdsaRecoverableSignatureOut, string $sig64, int $recId): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_recoverable_signature_convert($context, ?resource &$ecdsaSignature, $ecdsaRecoverableSignature): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_sign_recoverable($context, ?resource &$ecdsaRecoverableSignatureOut, string $msg32, string $secretKey): int {}
/**
 ...
 * @return int
 */
function secp256k1_ecdsa_recover($context, ?resource &$ecPublicKey, $ecdsaRecoverableSignature, string $msg32): int {}
/**
