...
class Secp256k1EcdsaRecoverCompactTest extends TestCase
{
    public function testVerifyCompact()
    {
        ...
        $s = '';
        $this->assertEquals(1, secp256k1_ecdsa_signature_parse_compact($context, $sig, $s, $recid));
        ...
        $ePubKey = '';
        $this->assertEquals(1, secp256k1_ec_pubkey_serialize($context, $publicKey, $compressed, $ePubKey));
        ...
        $serPubKey = '';
        $this->assertEquals(1, secp256k1_ec_pubkey_serialize($context, $recPubKey, $compressed, $serPubKey));
    ...
    public function getErroneousTypeVectors()
    {
        ...
        $sig = pack("H*", 'fe5fe404f3d8c21e1204a08c38ff3912d43c5a22541d2f1cdc4977cbcad240015a3b6e9040f62cacf016df4fef9412091592e4908e5e3a7bd2a42a4d1be01951');
        $s = '';
        $this->assertEquals(1, secp256k1_ecdsa_signature_parse_compact($context, $sig, $s));
