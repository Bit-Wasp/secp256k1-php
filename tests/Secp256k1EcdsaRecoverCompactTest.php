...
class Secp256k1EcdsaRecoverCompactTest extends TestCase
{
    public function testVerifyCompact()
    {
        ...
        $this->assertEquals(1, secp256k1_ec_pubkey_create($ctx, $privateKey, 0, $publicKey));
        ...
        $compressed = 0;
        $recPubKey = '';
        $this->assertEquals(1, secp256k1_ecdsa_recover_compact($ctx, $msg, $sig, $recid, $compressed, $recPubKey));
    ...
    public function testErroneousTypes($msg32, $sig, $recid, $compressed)
    {
        $publicKey = '';
        $ctx = $this->context();
        \secp256k1_ecdsa_recover_compact($ctx, $msg32, $sig, $recid, $compressed, $publicKey);
    }
}
